...
The script does include some essential processing necessary before the appropriate routines are called. It is recommended to examine the script in detail and draw inspiration from it when creating your own, to get a feel for what the code can handle by itself, and what your script must provide it with.
