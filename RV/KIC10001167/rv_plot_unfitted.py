...
model_dir = '/home/sinkbaek/PycharmProjects/Seismic-dEBs/Binary_Analysis/JKTEBOP/gaulme2016/KIC10001167/kepler_kasoc/'
...
data_dir = '/home/sinkbaek/PycharmProjects/Seismic-dEBs/RV/Data/additionals/separation_routine/10001167/'
...
time_A = time_A  # + 55028.0908
time_B = time_B  # + 55028.0908


# index_B = index_B.astype(int)
# print(index_B)

index_B = [29, 28, 21, 24, 27, 9, 20, 13, 1, 10, 25, 11, 30, 7, 12, 8, 22, 26, 6, 15, 14, 4, 5, 17, 16, 18]
index_B = np.sort(index_B)

time_B = time_B[index_B]
rv_B = rv_B[index_B]

systemic_rv_estimate = 0
...
phase_eclipse = 0.4152
approximate_hwidth= 0.02

ax1.errorbar(phase_A, rv_A, fmt='*', color='blue')
ax1.errorbar(phase_B, rv_B, fmt='*', color='red')
...
save_array[:, 0] = time_A + 55028.0908
save_array[:, 1] = rv_A -103.40
save_array[:, 2] = 0.01
np.savetxt('rvA.dat', save_array)

save_array = np.empty((time_B.size, 3))
save_array[:, 0] = time_B + 55028.0908
save_array[:, 1] = rv_B -103.40
save_array[:, 2] = 0.01
