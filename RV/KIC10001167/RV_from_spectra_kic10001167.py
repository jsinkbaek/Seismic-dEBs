...
estimate_RVb_from_RVa = True        # defines if a guess on RVb should be made in case it cannot be picked up during
                                    # initial fitting
mass_A_estimate = 2.15
mass_B_estimate = 0.79
system_RV_estimate = -103.40  # 11.7  # 12.61  # 16.053 19.44
orbital_period_estimate = 120.3903  # only for plotting

# # Stellar parameter estimates (relevant for limb darkening calculation) # #
Teff_A, Teff_B = 4700, 6200
logg_A, logg_B = 2.14, 4.36
MH_A  , MH_B   = -0.69, -0.69
...
RV_guesses_B = -RV_guesses_A * 25.9/25.1  # (mass_A_estimate / mass_B_estimate)
