...
RV_guesses_A, RV_guesses_B, _ = cRV.radial_velocities_of_multiple_spectra(
    flux_collection_inverted, flux_template_A_inverted, delta_v, ifitpar_A, ifitpar_B, number_of_parallel_jobs,
    plot=False
)
