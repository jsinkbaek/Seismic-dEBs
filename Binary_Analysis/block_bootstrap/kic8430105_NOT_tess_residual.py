...
rvA_model = np.loadtxt('Data/rvA.NOT.TESS.model', unpack=True, usecols=4)
rvB_model = np.loadtxt('Data/rvB.NOT.TESS.model', unpack=True, usecols=4)
param_names = [
...
for n_blocks in n_blocks_list:
    ...
    np.savetxt(f'Results/vals.NOT.TESS.resi.{n_blocks}', vals)